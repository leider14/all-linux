...
const Color myClrBaseColor = Color.fromARGB(255, 70, 56, 198);
const Color myClrBaseColorLight = Color.fromARGB(255, 216, 212, 254);
...
const Color myClrBackground = Color.fromARGB(255, 247, 247, 247);
